...
function doIOS7()
{
  ...
  // Select Icon file
  var file = File.openDialog("Select your base image file, this should be 1024x1024.px for best results! your new icon files will be saved here as well.");
  ...
  */
  ...
  alert("Done\nAll IOS icons have been saved beside your original icons.")
...
function doAndroid()
{
  ...
  // Select Icon file
  var file = File.openDialog("Select your icon file this should be 1024x1024.px for best results! your new icon files will be saved here as well.");
  if(file == null) return; // cancelled.
  app.open(file);
  var path =  file.absoluteURI.substr(0,file.absoluteURI.lastIndexOf("/")+1);
  ...
  activeDocument.saveAs(File(path + "/512.png"), pngOptions, true);
  ...
  alert("Done\nAll ANDROID icons have been saved beside your original Image.")
